...
esAmigoQueBuscamos red u2 (u1:amigosU1) visitados | fst u2 == fst u1 = True
                                                  ...
                                                  | otherwise = esAmigoQueBuscamos red u2 (amigosU1 ++ amigosDe red u1) visitados--Reviso los amigos de u1 y los agrego a una lista con todos los amigos de los usuarios
